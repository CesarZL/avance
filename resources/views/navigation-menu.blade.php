          ...
          <div class="flex h-16 items-center">
            ...
            <div class="ml-4 flex lg:ml-0">
              <a href="/">
                ...
                <svg id="a" data-name="Capa 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390.4 390.4" class="h-8 w-auto">
            ...
            <div class="hidden lg:ml-8 lg:block lg:self-stretch">
              <div class="flex h-full space-x-8">  
                <a href="#" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Inicio</a>
                {{-- @if ({{ Auth::user()->type=='paciente' }}) si el usuario autenticado es un paciente se le muestran las citas --}}
                @if (!Auth::check() or Auth::user()->type=='paciente')
                    <a href="{{ route('consulta.create') }}" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Consultas</a>
                @endif
                @if (Auth::check() and Auth::user()->type=='admin')
                    <a href="{{ route('doctores.index') }}" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Doctores</a>
                @endif
                @if (Auth::check() and Auth::user()->type=='doctor')
                    <a href="{{ route('citas.index') }}" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Citas</a>
                    <a href="{{ route('horarios.index') }}" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Mis horarios</a>
                @endif


                <a href="#" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Productos</a>
                <a href="#" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Médicos</a>
            ...
            <div class="ml-auto flex items-center">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                    <a href="{{ route('login') }}" class="text-sm font-medium text-gray-700 hover:text-gray-800">Iniciar sesión</a>
                ...
                <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                     ...
                     <form method="POST" action="{{ route('logout') }}" x-data>
                        ...
                        <a class="text-sm font-medium text-red-500 hover:text-red-600" href="{{ route('logout') }}"
